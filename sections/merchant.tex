...
For the current market situation $\vec{s}$ and weights $\vec{\beta}$, $\vec{\beta} \in \mathbb{R^M}$, optimal policies (cf.~\cref{eq:joint_best_price_order}) are derived by, $n=0, 1, \ldots, N_{max}$,
