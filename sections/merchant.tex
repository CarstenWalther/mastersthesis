...
The Quality is measured as L2-norm of the difference from predicted to true probabilities over the parameters $i = 0, 1, \ldots, 10$ and $a = 20, 21, \ldots, 40$.
