...
%check: flatten  graph to save page space
\begin{figure}[t]
\begin{tikzpicture}
\begin{axis}[
...
We makes 10 successive dynamic programming calculations with 20 iterations each.
