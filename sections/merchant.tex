...
\Big)\Bigg\}
\end{split}
\label{eq:joint_best_price}
\end{equation}

\begin{equation}
\begin{split}
b^*_t(n) = \argmax_{b \in B_t} \Bigg\{
\sum_{i = 0}^{N_{max}}
P(i, a) \cdot \Big((
a \cdot min(i, n) %sales
- l \cdot n % holding cost
...
This sales probability function is used in \cref{eq:joint_best_price,eq:joint_best_order} to calculate optimal ordering and pricing policies.
