...
%problem: price (and order) optimization is hard (competition, unknown customer behavior/limited demand info)
%decisions mutually dependend
%why is problem important: profitability
%what we done?:
%	optimized joint pricing + ordering strategies
%	demand learning to estimate sales probs
%	implemented, evaluated on platform (different scenarios with competition)
%result: outperforms rule-based merchants
%
%platform
%problem: retailers lack possibility to test new strategies
%price wars 