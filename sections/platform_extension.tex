...
\end{tikzpicture}
%area under graph
\caption[Holding costs calculation]{
...
The benchmark tool is a python script. The command to run it is \texttt{python3 helper\_scripts/benchmark.py}.

%python3 helper_scripts/benchmark.py -o ../runs -d 15 --merchants "python3 /home/carsten/pricewars-merchant/merchant_scenario4.py --port 5001" "python3 /home/carsten/pricewars-merchant/merchant_scenario4.py --port 5002 --name \"Data-Driven Merchant 2\"" --holding_cost 3
